...
variable "opensearch_master_username" {
  description = "Username for the master opensearch user."
  default     = ""  
}

variable "opensearch_master_username_secret_name" {
  description = "Secret name for the master opensearch user."
  default     = ""  
}

variable "opensearch_master_password" {
  description = "Password for the master opensearch user."
  default     = ""  
}

variable "opensearch_master_password_secret_name" {
  description = "Secret Name for the master opensearch user."
  default     = ""  
}